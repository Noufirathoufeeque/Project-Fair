...
function Footer() {
  return (
    <div style={{height:'350px'}} className='container-fluid w-100 mt-5 bg-primary '>
    ...
    <p className='text-center mt-5' style={{color:'white'}}>Copyright © Jan Batch 2024 Project Fair.Built with React.</p>
    </div>
  )
}
